...
HAL_StatusTypeDef sgtl5000_i2c_read_register(I2C_HandleTypeDef *hi2c, sgtl5000_registers_t reg_address, uint16_t * data);
HAL_StatusTypeDef sgtl5000_i2c_write_register(I2C_HandleTypeDef *hi2c, sgtl5000_registers_t reg_address, uint16_t data);
HAL_StatusTypeDef sgtl5000_i2c_set_bit(I2C_HandleTypeDef *hi2c, sgtl5000_registers_t reg_address, uint16_t set_mask);
HAL_StatusTypeDef sgtl5000_i2c_clear_bit(I2C_HandleTypeDef *hi2c, sgtl5000_registers_t reg_address, uint16_t clear_mask);

HAL_StatusTypeDef sgtl5000_init(I2C_HandleTypeDef *hi2c);

#endif /* INC_SGTL5000_C_ */
